...
* выдать пользователю корпоративный аккаунт и добавить ему дополнительно опцию с 10-ю точками продаж (для api-1 [https://admin-api-1.testms-test.lognex.ru](https://admin-api-1.testms-test.lognex.ru/))
