...
**updated** | **\DateTime** | Момент последнего обновления Точки продаж | [optional] [readonly]
...
**state** | [**\OpenAPI\Client\Model\Status**](Status.md) |  | [optional]
**fiscal_type** | [**\OpenAPI\Client\Model\FiscalType**](FiscalType.md) |  | [optional]
**default_tax_system** | [**\OpenAPI\Client\Model\TaxSystem**](TaxSystem.md) |  | [optional]
**order_tax_system** | [**\OpenAPI\Client\Model\TaxSystem**](TaxSystem.md) |  | [optional]
**minion_to_master_type** | [**\OpenAPI\Client\Model\MinionToMasterType**](MinionToMasterType.md) |  | [optional]
**tobacco_mrc_control_type** | [**\OpenAPI\Client\Model\TobaccoMrcControlType**](TobaccoMrcControlType.md) |  | [optional]
**marking_selling_mode** | [**\OpenAPI\Client\Model\MarkingSellingMode**](MarkingSellingMode.md) |  | [optional]
**marks_check_mode** | [**\OpenAPI\Client\Model\MarksCheckMode**](MarksCheckMode.md) |  | [optional]
**priority_ofd_send** | [**\OpenAPI\Client\Model\PriorityOfdSend**](PriorityOfdSend.md) |  | [optional]
...
**customer_order_states** | [**\OpenAPI\Client\Model\RetailStoreCustomerOrderStatesInner[]**](RetailStoreCustomerOrderStatesInner.md) | Возможные состояния заказов покупателей | [optional]
