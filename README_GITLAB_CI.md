...
Публикуемый Java runtime-артефакт собирается как self-contained shaded JAR с relocation зависимостей (Jackson/HttpClient и связанных модулей) внутрь SDK.
