...
| `github.com/moysklad/remap-1.2-python-sdk` | Public GitHub Python SDK |
...
| `git.company.lognex/moysklad/misc/remap-1.2-python-sdk` | Internal GitLab Python SDK |
...
- **SDK generation:** OpenAPI Generator CLI (PHP, Python, Java); Python model behavior is generated by `customtemplates/python/`, while `scripts/prepare-python-sdk-layout.py` only cleans packaging files and moves the package under `src/`
...
customtemplates/python/                # Python model behavior and src-layout package metadata templates
...
| `prepare-sdk-repository` | PHP/Java/Python `prep-branch-and-mr-*`, `merge-branch-*` | push/web (branch) / master push |
| `deploy-sdk` | Java Artifactory/Maven and Python TestPyPI/PyPI jobs | branch manual / master release |
